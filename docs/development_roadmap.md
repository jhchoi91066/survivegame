...
- [ ] 시각적 개선
  - [ ] 장애물 아이콘 추가 (🪨 바위, 🌊 물, 🚪 통로 등)
  - [ ] 날씨 아이콘 추가 (☀️ 맑음, 🌧️ 비, ⛈️ 폭풍)
  - [ ] 생존자 역할별 아이콘 (👷 엔지니어, 👨‍⚕️ 의사, 👨‍🍳 요리사, 👶 아이)
  - [ ] 구조 지점 시각화 개선 (🚁 헬리콥터 등)
- [ ] UI/UX 개선
  - [ ] GameOverModal에 "다음 레벨" 버튼 추가
  - [ ] 레벨 선택 화면에 레벨 이름 표시
  - [ ] 능력 사용 가능 여부 시각적 표시 (비활성화 상태)
  - [ ] 이동 불가능한 타일 표시 (빨간색 오버레이)
  - [ ] 로딩 인디케이터 추가 (레벨 로드 중)

### 3. 폴리싱 (Priority 3 - 선택적)
- [ ] 애니메이션 강화
  - [ ] 승리 시 축하 애니메이션 (파티클, 별 효과)
  - [ ] 데미지 입을 때 shake 애니메이션
  - [ ] 능력 사용 시 이펙트 애니메이션
  - [ ] 날씨 변화 transition 애니메이션
  - [ ] 턴 종료 시 fade 효과
- [ ] 통계 시스템
  - [ ] 통계 화면 추가 (총 별 수, 클리어율, 플레이 시간)
  - [ ] 레벨별 최고 기록 표시
  - [ ] 업적 시스템 기초 구현
- [ ] 튜토리얼 개선
